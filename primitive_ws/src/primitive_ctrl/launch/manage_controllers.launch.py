...
def generate_launch_description():
    ...
    logger.info(colorize(46, "\n\n\t\t\t\t\t\t\tStarting the Launch file...\n\n     \
        This node does the following: 1. Stop the <scaled_joint_trajectory_controller>\n  \
            \t\t\t\t2. Setup Cartesian Ctrl <cartesian_motion_controllers>\n  \
            \t\t\t\t3. Modify Params of <cartesian_motion_controller>: solver.error_scale \
            \n\n        \
                "))
