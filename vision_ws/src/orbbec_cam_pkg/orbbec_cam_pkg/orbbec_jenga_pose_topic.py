# run "ros2 launch orbbec_camera gemini_intra_process_demo_launch.py color_width:=1280 color_height:=720 color_fps:=30 color_format:=MJPG"  to initialize the camera before running this code for Orbbec
