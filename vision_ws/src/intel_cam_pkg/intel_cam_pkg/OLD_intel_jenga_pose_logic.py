...
class ArucoJengaBlockDetector(Node):
    ...
    def detect_aruco_marker(self, cv_image):
        ...
        corners, ids, _ = cv2.aruco.ArucoDetector.detectMarkers(gray, self.aruco_dict_origin, parameters=self.aruco_params_origin)
    ...
    def detect_aruco_markers(self, cv_image):
        ...
        corners, ids, _ = aruco.ArucoDetector.detectMarkers(gray, self.aruco_dict_jenga, parameters=self.aruco_params_jenga)
